...
app_name = 'finlife'
urlpatterns = [
    path('', views.api_test, name='api_test'),
    ...
    path('deposit-productdeposit-product-options/<str:fin_prdt_cd>/', views.deposit_product_options, name='deposit_product_options'),
